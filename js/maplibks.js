...
(function(){
    ...
    Cluster.prototype.updateGridBounds = function() {
		...
		// 		}
				...
				var content = '<span style="color:' + colostyle +'"><i class="fa fa-map-marker" ></i></span>' + '<p ids="' + ids +'"  docName="' + docName +'" lasts="' + lasts +'" lngs="' + lngs +'"  docUrl="' + docUrl +'"  docType="' + docType +'"  address="' + address +'" class="clicks fa-map-markerClasz" style="background:' + colostyle +'" >' + docName + '</p>';
