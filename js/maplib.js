...
(function() {
	...
	function Cluster(markerClusterer) {
		...
		// 		console.log(markerClusterer._names);
...
// 		return true;
	...
	Cluster.prototype.addLabel = function(marker) {
		//获取marker的坐标
		var position = marker.getPosition();
		// console.log(marker.point.name);
		//创建label
		var label = new BMap.Label({
			position: position
		});
		var ids = marker.point.ids;
		var docName = marker.point.docName;
		var docUrl = marker.point.docUrl;
		var address = marker.point.address;
		var lasts = marker.point.lasts;
		var lngs = marker.point.lngs;
		var docType = marker.point.docType;
		var docColor = marker.point.docColor;
		// console.log(docColor);
		// var names = marker.point.name ;
		var colostyle = docColor;
		// 		if(docType == "1"){
		// 			colostyle = "rgb(71, 131, 231)";
		// 		}
		// 		if(docType == "2"){
		// 			colostyle = "rgb(235,164,65)";
		// 		}
		// 		if(docType == "3"){
		// 			colostyle = "rgb(94,146,85)";
		// 		}
		// 		if(docType == "4"){
		// 			colostyle = "rgb(125,58,169)";
		// 		}
		// 		if(docType == "5"){
		// 			colostyle = "rgb(255,250,232)";
		// 		}
		// this._styles[0].backgroundColor
		label.setStyle({
			height: '0px',
			color: "#fff",
			backgroundColor: colostyle,
			border: 'none',
			borderRadius: "25px",
			fontWeight: 'bold',
		});
		// var content = '<span style="font-size:5px;color:' + colostyle +'">' + docName + '</span>'
		var content = '<span style="color:' + colostyle + '"><i class="fa fa-map-marker" ></i></span>' + '<p ids="' + ids +
			'"  docName="' + docName + '" lasts="' + lasts + '" lngs="' + lngs + '"  docUrl="' + docUrl + '"  docType="' +
			docType + '"  address="' + address + '" class="clicks fa-map-markerClasz" style="background:' + colostyle + '" >' +
			docName + '</p>';
	...
	Cluster.prototype.updateClusterMarker = function() {
		...
		// console.log(this._markerClusterer._names);
		this._clusterMarker.setText({
			name: '<p class="all-text">' + this._markerClusterer._names + '</p>',
			value: this._markers.length
		});
